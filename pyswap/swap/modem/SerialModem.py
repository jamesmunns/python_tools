...
class SerialModem:
    ...
    def __init__(self, portname="/dev/ttyUSB0", speed=38400, verbose=False, invert=False):
        """
        Class constructor
        ...
        try:
            # Open serial port
            self._serport = SerialPort(portname=self.portname,
                                       speed=self.portspeed,
                                       verbose=verbose,
                                       invert_dtr_rts=invert)
